...
@WebServlet(name = "allClientsBeforeTheirRemovingServlet")
public class AllClientsBeforeTheirRemovingServlet extends HttpServlet {

    private static final Logger Log = LoggerFactory.getLogger(AllClientsBeforeTheirRemovingServlet.class);

    protected void doGet(HttpServletRequest request, HttpServletResponse response) {

        Log.info("Getting all clients for removing all clients");
        try {
